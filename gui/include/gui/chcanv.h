...
private:
  ...
  /**
   * Draws crosshairs at the route timing calculation position.
   *
   * Only draws when route rollover is active and route has timing data.
   * Position may differ from cursor due to route interpolation.
   *
